...
ext["kotlin-coroutines.version"] = System.getProperty("kotlinCoroutinesVersion")
...
dependencies {
    ...
    implementation("io.github.oshai:kotlin-logging-jvm:" + System.getProperty("kotlinLoggingVersion"))
